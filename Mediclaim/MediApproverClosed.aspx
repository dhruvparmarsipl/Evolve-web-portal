<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MediApproverClosed.aspx.cs" Inherits="MediApproverClosed" %>
...
<head id="Head1" runat="server">
    ...
    <title>Processed Mediclaims</title>
                ...
                <div class="pageWidth" id="PageContPrint">
                    ...
                    <div class="row mBtm20" style="position: relative">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formB brd">
                                        ...
                                        <asp:GridView ID="grdvDependantsDetail" Width="100%" runat="server"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="NAME" ItemStyle-Width="20%"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtNameOfDependant" runat="server" Text='<%#Eval("NAME") %>'>
                                                        </asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="DOB(dd/mm/yyyy)" ItemStyle-Width="15%"
                                                    HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtDOB"  onkeypress="return false" onkeydown="return false" oncut="return false" runat="server"
                                                            onpaste="return false"  Text='<%#Eval("DOB") %>'>
                                                        </asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Blood Group" ItemStyle-Width="10%"
                                                    HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left">
                                                    <ItemTemplate>
                                                         <asp:Label ID="ddlBloodGroup"  runat="server" Text= '<%#CheckBloodGroup((Eval("BLOODGROUP"))) %>'>
                                                        </asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Relation" ItemStyle-Width="14%"
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="ddlRelation"   runat="server" Text='<%#Eval("RELATION") %>'>
                                                        </asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Remarks" ItemStyle-Width="20%" HeaderStyle-HorizontalAlign="Left"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtRemarks" ReadOnly="true" Visible="false" runat="server" CssClass="inpt inpt3" Text='<%#Eval("REMARKS") %>'></asp:TextBox>
                            ...
                            <tr>
                                <td align="center" valign="top" style="margin-top: 10px; margin-bottom: 10px;" colspan="6">
                                    <asp:LinkButton ID="lnkbtnRevert" OnClick="lnkbtnRevert_Click" Visible="false" runat="server" OnClientClick="return Confirm('Are you sure you want to revert the user form status.')" CssClass="btnSave">Revert To User
                                    </asp:LinkButton>
