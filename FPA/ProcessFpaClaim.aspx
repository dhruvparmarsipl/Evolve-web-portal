<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProcessFpaClaim.aspx.cs" Inherits="ProcessFpaClaim" %>
                        ...
                        <asp:GridView ID="grdUser" Width="100%" runat="server" CssClass="grdMain" EmptyDataRowStyle-CssClass="grdRows"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="SL No" HeaderStyle-HorizontalAlign="left" ItemStyle-Width="30%"
                                    ...
                                    <ItemTemplate>
                                        <a target="_blank" href="FpaApprover.aspx?RID=<%#DoEncrypt(Eval("SerialNo").ToString()) %>">
                                            <%#Eval("SerialNo")%></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
