<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyFlexiDeclartion.aspx.cs" Inherits="MyFlexiDeclartion" %>
                            ...
                            <div class="rownew mBtm20new">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formBnew brdnew">
                                    ...
                                    <tr>
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtTotAllownce" runat="server" CssClass="inptnew inpt2new" ReadOnly="true"></asp:TextBox>
                                        </td>
                                        <td width="33%" align="left" valign="center">
                                            <strong>Total Deduction</strong></td>
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtTotDeduct" runat="server" ReadOnly="true" CssClass="inptnew inpt2new"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtNetAmount" runat="server" ReadOnly="true" CssClass="inptnew inpt2new"></asp:TextBox>
                                        </td>
                                        <td width="33%" align="left" valign="center">
                                            <strong>Yet To Allocate</strong></td>
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtYAllocate" runat="server" ReadOnly="true" CssClass="inptnew inpt2new"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formBnew brdnew">
                                            ...
                                            <asp:GridView ID="gvsalarydist" runat="server" ShowFooter="true" Width="100%" EmptyDataText="No Record Found."
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Yearly Allocation" HeaderStyle-HorizontalAlign="Left">
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtTotalSalaryamount" runat="server" Enabled="false" 
                                                                CssClass="inptnew inpt2new"></asp:TextBox>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            ...
                                            <asp:GridView ID="gvFPADistribution" runat="server" Width="100%" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Yearly Allocation">
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtTotalFPAamount" Enabled="false"  runat="server"
                                                                CssClass="inptnew inpt2new"></asp:TextBox>
                                                        </FooterTemplate>
