                                            ...
                                            <asp:GridView ID="gvClaimDetail" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Bill Amount">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtBillAmount" CausesValidation="true"  CssClass="inptnew inpt2new" runat="server" AutoPostBack="true" TabIndex="1"
                                                    ...
                                                    <asp:TemplateField HeaderText="Detail">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtDetail" TextMode="MultiLine" Rows="3" Columns="4" CssClass="inpt"  runat="server" ></asp:TextBox>
...
<td width="40%" align="left" valign="top" class="greyBg">
 ...
 <td align="left" valign="top">
                         ...
                         Submit</asp:LinkButton>
                                            ...
                                            <td width="10%" align="left" valign="top">
                                                <asp:LinkButton ID="btnSaveDraft" runat="server" CssClass="button" ValidationGroup="add"
