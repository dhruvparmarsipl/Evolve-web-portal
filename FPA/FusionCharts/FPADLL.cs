...
//new SqlParameter("@DESID", DesId), new SqlParameter("@SAPID", EmpSapId), new SqlParameter("@YEAR", year),
   ...
   public DataTable GetFpaHeads(string location, int DesId,string Carscheme,string Bu)
    ...
    public int InsertMyApprovalClaim(string gridSalaryHeadXml, string gridFPAHeadXml, int CycleId, int FpaId, string status, string SapId)
    {
        using (SqlConnection con = ReturnSqlconnection())
        {
  ...
  public int FPA_Insert_year_end(string desId, string Loc,string Owner)
    ...
    public int InsertMyApprovaltoFPA(string gridSalaryHeadXml, string gridFPAHeadXml, int CycleId, int FpaId, string status, string SapId, string UserComment)
    {
        using (SqlConnection con = ReturnSqlconnection())
        {
            return Convert.ToInt32(SqlHelper.ExecuteScalar(con, CommandType.StoredProcedure, "FPA_InsertToFPA",
    ...
    public int InsertMyApprovaltoFPAForGM(string gridSalaryHeadXml, string gridFPAHeadXml, int CycleId, int FpaId, string status, string SapId, int Basiccomp, int retrialbcomp, int basicretrial, string UserComment)
    {
        using (SqlConnection con = ReturnSqlconnection())
        {
...
public DataTable getDataForFIAdminPetrol(string owner, string ststus, string Stext)
 ...
 public DataTable GetUserFpaReInitiateDetail(string FpaSapId)
  ...
  public int reinitiationTest(string FpaId, string DesId, string EmpSapId, string year, string commnets, int Fpa, int other1, int other2, int other3, int Locfpa, int totpetrol, int totreimavail, int clarental, int vehemi, int saf, int busdeduct, string serial, int totSalAvail, string Carscheme)
    {
        using (SqlConnection con = ReturnSqlconnection())
        {
 ...
 public DataTable GetUserFpaInitiateDetail(string Ecode, string FpaSapId)
    ...
    public int InsertFPANewTest(string DesId, string EmpSapId, string year, string commnets, int Fpa, int other1, int other2, int other3, int Locfpa, int totpetrol, int totreimavail, int clarental, int vehemi, int saf, int busdeduct, string serial, int totSalAvail, string Carscheme)
    {
        using (SqlConnection con = ReturnSqlconnection())
        {
