...
<script type="text/javascript">
    ...
    function UserDetail(Sapid, DesId, Ename, Email, Loc, Designation, Ecode, carscheme) {
        ...
        if (parseInt(DesId) < 21) {
            ...
            txtBasicSalary.style.display = 'none';
        }
        else {
            ...
            txtBasicSalary.style.display = 'block';
    ...
    function SubmitFpa() {
        ...
        if (Sapid != '' && DesId != '' && NetAmount > 0) {
            $.ajax({
                ...
                data: "{Fpa:'" + Fpa + "',CTC:'" + CTC + "',cBasic:'" + cBasic + "',other1:'" + other1 + "',other2:'" + other2 + "',other3:'" + other3 + "',totpetrol:'" + totpetrol + "',Locfpa:'" + Locfpa + "',busdeduct:'" + busdeduct + "',saf:'" + saf + "',vehemi:'" + vehemi + "',totSalAvail:'" + totSalAvail + "',totreimavail:'" + totreimavail + "',clarental:'" + clarental + "',Sapid:'" + Sapid + "',DesId:'" + DesId + "',EamilId:'" + EamilId + "',NetAmount:'" + NetAmount + "',Comment:'" + Comment + "',totdeduct:'" + totdeduct + "',totAllow:'" + totAllow + "',Ename:'" + Ename + "',Carscheme:'" + Carscheme +"',BasicSalary:'" + BasicSalary + "'}",
                dataType: "json",
