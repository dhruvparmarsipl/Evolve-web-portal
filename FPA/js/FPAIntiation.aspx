                            ...
                            <div class="row mBtm20">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formBnew brd">
                                    ...
                                    <tr id="trgm" runat="server">
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtCTC" runat="server" MaxLength="9" CssClass="inptnew inpt2new"
                                                onfocus ="clearContents(this, event);" onkeyup="javascript:fpaCompute()" onblur="checkCTC(this);clearContents(this, event);"
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtTotalsalavailed" MaxLength="8" runat="server"  onfocus ="clearContents(this, event);"
                                                CssClass="inptnew inpt2new" onblur="check(this);clearContents(this, event);" onkeyup="deductionCompute()"></asp:TextBox>
                                    ...
                                    <td id="Td1" width="33%" align="left" valign="center" runat="server">
                                            <strong>
                                                <asp:Literal ID="ltcbasic" runat="server" Text="Current Basic"></asp:Literal></strong></td>
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtcBasic" runat="server" MaxLength="9" CssClass="inptnew inpt2new"
                                                 onfocus ="clearContents(this, event);" onblur="check(this);clearContents(this, event);"
                                                OnTextChanged="txtcBasic_TextChanged"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td width="17%" align="left" valign="center">
                                           ...
                                           onfocus ="clearContents(this, event);" onkeyup="javascript:fpaCompute()" onblur="check(this);clearContents(this, event);"
                                                OnTextChanged="txtFPA_TextChanged"></asp:TextBox>
                                       ...
                                       <td width="33%" align="left" valign="center">
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtClaRental" runat="server" MaxLength="8" CssClass="inptnew inpt2new"
                                                 onfocus ="clearContents(this, event);" onkeyup="javascript:deductionCompute();" onblur="check(this);clearContents(this, event);"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtOther1" runat="server" MaxLength="8" CssClass="inptnew inpt2new"
                                                 onfocus ="clearContents(this, event);" onkeyup="javascript:fpaCompute()" onblur="check(this);clearContents(this, event);"
                                                OnTextChanged="txtOther1_TextChanged"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtOther2" runat="server" MaxLength="8" CssClass="inptnew inpt2new"
                                                onfocus ="clearContents(this, event);" onkeyup="javascript:fpaCompute()" onblur="check(this);clearContents(this, event);"
                                                OnTextChanged="txtOther2_TextChanged"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtLocFPA" runat="server" MaxLength="8" CssClass="inptnew inpt2new"
                                                 onfocus ="clearContents(this, event);" onkeyup="javascript:fpaCompute()" onblur="check(this);clearContents(this, event);"
                                                OnTextChanged="txtLocFPA_TextChanged"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtOther3" runat="server" MaxLength="8" CssClass="inptnew inpt2new"
                                                 onfocus ="clearContents(this, event);" onkeyup="javascript:fpaCompute()" onblur="check(this);clearContents(this, event);"
                                                OnTextChanged="txtOther3_TextChanged"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtTotpcredited" runat="server" MaxLength="8" CssClass="inptnew inpt2new"
                                              ReadOnly="true" Enabled="false" onblur="check(this);clearContents(this, event);"
                                                OnTextChanged="txtTotpcredited_TextChanged"></asp:TextBox>
