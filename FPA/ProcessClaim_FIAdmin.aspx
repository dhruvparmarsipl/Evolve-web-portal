...
<div class="searchArea">
                 ...
                 <asp:DropDownList ID="ddlSearchCriteria" runat="server" CssClass="searchByName">
                                    <asp:ListItem Value="0" Selected="True">Search By</asp:ListItem>
                                    <asp:ListItem Value="Name">ECode</asp:ListItem>
                                    <asp:ListItem Value="SRNO">Serial No.</asp:ListItem>
                                </asp:DropDownList>
