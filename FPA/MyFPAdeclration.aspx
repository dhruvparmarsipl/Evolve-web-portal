       ...
       popup.hide();
        ...
        <asp:UpdatePanel ID="updcommon" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:HiddenField ID="hfNPSAmt" runat="server" />
                <div id="wrappernew">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formBnew brdnew">
                                    <tr>
                                        ...
                                        <td colspan="3" align="left" valign="top" class="head">
                                            <asp:RadioButtonList ID="rdbNPSMode" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdbNPSMode_SelectedIndexChanged">
                                    ...
                                    <tr id="trFirstRow" runat="server" visible="false">
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtPranNo" runat="server"   CssClass="inptnew inpt2new"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rqvtxtPranNo" runat="server" ControlToValidate="txtPranNo"
                                                Display="Dynamic" ValidationGroup="add12121212" Text="*" ErrorMessage=" Please enter Pran No.">
                                            </asp:RequiredFieldValidator>
                                        </td>
                                        <td width="33%" align="left" valign="center">
                                            <strong>Associated Bank</strong><span style="color:red"></span></td>
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtAsBank" runat="server"   CssClass="inptnew inpt2new"></asp:TextBox>
                                           
                                            <asp:RequiredFieldValidator ID="rqvddlAsBank" runat="server" ControlToValidate="txtAsBank"
                                                Display="Dynamic" ValidationGroup="add12121212" Text="*" ErrorMessage="Please enter associated bank.">
                                            </asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr id="trThirdRow" runat="server" visible="false">
                                        ...
                                        <td width="17%" align="left" valign="center">
                                            <asp:TextBox ID="txtNPSValue" runat="server" CssClass="inptnew inpt2new" onpaste="return false"
                                                onkeypress="return isNumberKey(event);" AutoPostBack="True" OnTextChanged="txtNPSValue_TextChanged"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1"   runat="server" SetFocusOnError="true" ControlToValidate="txtNPSValue"
                                                Display="Dynamic" ValidationGroup="add" Text="*" ErrorMessage="Please enter NPS amount.">
                                            </asp:RequiredFieldValidator>
                                        </td>
                                        <td width="33%" align="left" valign="center">
                                            <strong></strong></td>
									 ...
									 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formB brd">
                                         <tr>
                                             <td  align="center" valign="top" style="margin-top:10px; margin-bottom:10px;">
                                                 ...
                                                 <asp:LinkButton ID="btnSubmit" runat="server" CssClass="butnew" ValidationGroup="add" OnClick="btnSubmit_Click">
