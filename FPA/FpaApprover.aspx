                        ...
                        <div class="pageWidth">
                            <div class="row mBtm20">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formB brd">
                                    <tr>
                                        ...
                                        <td align="left" width="15%" colspan="1" valign="top" class="head"><strong>SAP Voucher No : </strong></td>
                                          <td align="left" width="15%" class="top_bdr head" valign="top" colspan="2" >
                                          <asp:Label ID="lblSapVoucherNo"  runat="server" ForeColor="Black"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="12%" align="left" valign="top">
                                            <strong>BU/ Employee Code</strong>
                                        </td>
                                        <td width="13%" align="left" valign="top">
                                            <span id="spnBU" runat="server"></span>/  <span id="spnEmpCode" runat="server"></span>
                                        ...
                                        <td width="12%" align="left" valign="top">
                                            <span id="spnLoc" runat="server"></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>CCN</td>
                                        <td><span id="spnccn" runat="server"></span></td>
                                    </tr>
                            ...
                            <div class="row mBtm20">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formB brd">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" class="top_bdr" valign="top" width="30%">
                                            ...
                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterMode="InvalidChars" FilterType="Custom" InvalidChars="@,#,&lt;,&gt;,%,&amp;,^,$" TargetControlID="txtDetail">
                                            </cc1:FilteredTextBoxExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="8" align="left" valign="middle">
                                            <asp:GridView ID="dgvEntryDocs" Width="74%" runat="server" CellPadding="4" ForeColor="#333333"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="DocID In DMS" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDocIDInDMS" runat="server" Text='<%#Eval("DocIDInDMS")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                    ...
                                    <tr>
                                        <td colspan="8" align="left" valign="top" class="top_bdr">
                                            <asp:Button ID="btnAdd" Text="Add" runat="server" CssClass="but" OnClick="btnAdd_Click"
                                                ValidationGroup="ADD" />
                                            ...
                                            <asp:GridView ID="gvClaimDetail" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <img src="images/edit.png" alt="Delete" />
                                                            ...
                                                            <asp:LinkButton ID="lnkDeleteRow" runat="server" ToolTip="Delete" CommandArgument='<%#Eval("RowNo") %>'
                                    ...
                                    <tr>
                                        <td colspan="8" align="center" valign="middle">
                                            <div class="" runat="server" id="dvOnHoldDocumentsUpload" visible="false">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formB brd">
                                    ...
                                    <tr id="trcd" runat="server" visible="false">
                                        <td align="left" valign="top">Claim Deviation/ Comments</td>
                                        <td align="left" valign="top" colspan="2">
                                            <asp:DropDownList ID="ddlCD" runat="server" Width="90%"></asp:DropDownList>
                                            <br />
                                            <br />
                                            <asp:TextBox ID="txtddlCD" runat="server" TextMode="MultiLine" Height="46px" Width="90%" CssClass="inpt"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formB brd">
                                        <tr>
                                            <td align="center" valign="top" style="margin-top: 10px; margin-bottom: 10px;">
                                                <asp:LinkButton ID="btnApprove" runat="server" CssClass="butnew" OnClick="btnApprove_Click">
