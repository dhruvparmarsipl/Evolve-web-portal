<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InitiationStatus.aspx.cs"
                         ...
                         Show details</asp:LinkButton>
                             ...
                             <div class="rownew mBtm20new">
                                 <asp:GridView ID="gvEmployeeList" CssClass="grdMain" runat="server"  Width="100%" EmptyDataText="No Record Found."
                                     AutoGenerateColumns="false" OnDataBound="OnDataBound" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White">
                                     <Columns>
