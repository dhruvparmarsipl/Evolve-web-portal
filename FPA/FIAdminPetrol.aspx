<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FIAdminPetrol.aspx.cs" Inherits="FIAdminPetrol" %>
                                    ...
                                    <asp:GridView ID="GrdCoachApproval" Width="100%" runat="server" CssClass="grdMain"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Waiting for Approval" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="left"
                                                ...
                                                <ItemTemplate>
                                                    <a target="_blank" class="a<%#Eval("Positionid") %>" href="PetrolApprover.aspx?RID=<%#DoEncrypt(Eval("APP_SERIAL_NO").ToString()) %>">
                                                        <%#Eval("NAME")%>
                                                    </a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
