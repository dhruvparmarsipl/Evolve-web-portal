...
<body>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formB brd">
                                    <tr>
                                        ...
                                        <td align="right" valign="top" class="head">
                                            <h2 class="black18 wnor">
                                              <span style="display:none">   Rate: <span>&#8377;</span> <span id="txtRatePerKm" runat="server"></span><span> per KM </span></span>
                                            </h2>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <asp:GridView ID="gvPetrolClaimDetail" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Date Of Journey">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtJourneyDate" onkeypress="return false" onkeydown="return false"
                                                                CssClass="inpbox2" runat="server" AutoPostBack="true" OnTextChanged="txtJourneyDate_TextChanged"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField HeaderText="Rate ₹">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtRate" CssClass="inptnew inpt2new" runat="server" Enabled="false"></asp:TextBox>
                                                        </ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarktxtFIAdminreject" runat="server"
                                              ...
                                              <asp:RequiredFieldValidator ID="rqvtxtFIAdminreject" runat="server" ControlToValidate="txtFIAdminreject"
                                                                Display="Dynamic" ValidationGroup="hold" Text="*" ErrorMessage="*">
                                              </asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formB brd">
 ...
 <td width="10%" align="left" valign="top">
                                          <asp:LinkButton ID="btnDelete" runat="server" Visible="false" OnClick="btnDelete_Click" OnClientClick="return confirm('Are you sure you want to delete ?');" ValidationGroup="hold" CssClass="button">Delete</asp:LinkButton></td>
                                            <td width="10%" align="left" valign="top">
                                                <asp:LinkButton ID="btnHold" runat="server" CssClass="button" Visible="false"  ValidationGroup="hold" OnClick="btnHold_Click" >
                         Hold</asp:LinkButton>
                                            </td>
                                            <td width="10%" align="left" valign="top">
